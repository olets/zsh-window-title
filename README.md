...
ZSH_WINDOW_TITLE_PREFIX | format string | `''` | An optional prefix of the window title<br>If you set it, it will be separated by ` - ` to the beginning of the normal format
ZSH_WINDOW_TITLE_SUFFIX | format string | `''` | An optional suffix of the window title<br>If you set it, it will be separated by ` - ` to the end of the normal format
...
Variable | Type | Default | Use
---|---|---|---
ZSH_WINDOW_TITLE_IDLE | format string | `'${ZSH_WINDOW_TITLE_PREFIX:+"${ZSH_WINDOW_TITLE_PREFIX} - "}%$ZSH_WINDOW_TITLE_DIRECTORY_DEPTH~${ZSH_WINDOW_TITLE_SUFFIX:+" - ${ZSH_WINDOW_TITLE_SUFFIX}"}'` | The format for the window title when **no** process is running
ZSH_WINDOW_TITLE_ACTIVE | format string | `'${ZSH_WINDOW_TITLE_PREFIX:+"${ZSH_WINDOW_TITLE_PREFIX} - "}%$ZSH_WINDOW_TITLE_DIRECTORY_DEPTH~ - ${1[(w)1]}${ZSH_WINDOW_TITLE_SUFFIX:+" - ${ZSH_WINDOW_TITLE_SUFFIX}"}'` | The format for the window title when **a** process is running
